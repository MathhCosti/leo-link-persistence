...
p_break_th = Sth.p_break_delta;
p_break_th_linear = Sth.p_break_delta_linear;
...
fprintf('============================================================\n');
fprintf('p_break theorique probabiliste       : %.8f\n', ...
    p_break_th);
fprintf('p_break theorique lineaire           : %.8f\n', ...
    p_break_th_linear);
