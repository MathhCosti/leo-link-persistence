...
results_file = fullfile(script_dir, '..', 'leo_zigzag_analysis_results.mat');
...
[t_linked, vrel_linked, vrad_abs_linked, ratio_abs_linked] = plot_vrel_vs_vrad( ...
...
[t_bound, vrel_bound, vrad_abs_bound, ratio_abs_bound] = plot_vrel_vs_vrad( ...
    Positions, Velocities, time_values, dmax, ...
    'Pairs', 'near_boundary', ...
...
[t_merge, vrel_merge, vrad_merge, ratio_merge] = plot_vrel_vs_vrad( ...
    Positions, Velocities, time_values, dmax, ...
    'Pairs', 'near_boundary', ...
    'Width', boundary_width, ...
    'UseAbsRadial', false, ...
...
save('diagnostic_vrel_vrad_results.mat', ...
