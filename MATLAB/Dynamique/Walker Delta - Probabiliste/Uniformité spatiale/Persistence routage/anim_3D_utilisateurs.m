...
%% ============================================================
%  MODELE DELTA STOCHASTIQUE - UNIFORMITE SPATIALE
%  AVEC UTILISATEURS AU SOL
%
...
for k = 1:Nt
    ...
    set(title_handle, 'String', sprintf([ ...
        'Delta spatial + utilisateurs au sol | ' ...
...
save('delta_spatial_satellites_utilisateurs_rotation.mat', ...
...
fprintf(['Donnees sauvegardees dans ' ...
    'delta_spatial_satellites_utilisateurs_rotation.mat\n']);
