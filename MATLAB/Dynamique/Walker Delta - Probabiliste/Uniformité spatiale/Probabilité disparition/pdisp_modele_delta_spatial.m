...
lambda_candidates = { ...
    fullfile(script_dir,'lambda_effective_temp_delta_spatial_results.mat'), ...
    fullfile(script_dir,'..','lambda_effective_temp_delta_spatial_results.mat')};

vrel_candidates = { ...
    fullfile(script_dir,'vitesse_rel_temp_delta_spatial_theorique_strates.mat'), ...
    fullfile(script_dir,'..','vitesse_rel_temp_delta_spatial_theorique_strates.mat'), ...
    fullfile(script_dir,'..','Vitesse relative', ...
        'vitesse_rel_temp_delta_spatial_theorique_strates.mat')};

lambda_file = first_existing_file(lambda_candidates);
vrel_file = first_existing_file(vrel_candidates);
