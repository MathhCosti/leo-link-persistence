...
moments_file = 'N1_N2_N3_walker_delta_results.mat';
plink_file   = 'plink_walker_delta_semi_analytique_results.mat';
...
save('chi_bridge_uniformite_orbitale_results.mat', 'results');

fprintf('Résultats sauvegardés dans chi_bridge_uniformite_orbitale_results.mat\n');
