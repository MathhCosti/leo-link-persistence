...
ylim([0, min(1, 1.05*max([p_change; p_change_moving; eps]))]);
hold off;
...
yline(p_change_mean, '--', 'LineWidth', 1.2, ...
    'DisplayName', sprintf('moyenne globale p_{change} = %.3f', ...
    p_change_mean));
...
output_file = 'pmerge_pbreak_pchange_barcodes_delta_spatial.mat';
